        ...
        <div class="nav-wrap">
            ...
            <div class="nav-menu desktop-only">
                ...
                <div class="nav-menu-item">
                    <a href="?p=referral" class="nav-menu-link <?php echo ($current_page == 'referral') ? 'active' : ''; ?>">
...
<div class="sidebar" id="sidebar" style="visibility: hidden; transform: translateX(-100%);">
    ...
    <div class="sidebar-body">
        <div class="balance-card">
            ...
            <div class="balance-value"><i class="fas fa-wallet"></i> ฿<?php echo number_format($user['credit'], 2); ?>
            </div>
        </div>
