...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_general') {
        ...
        saveSetting($conn, 'navbar_style', $_POST['navbar_style'] ?? 'style1');
        saveSetting($conn, 'sidebar_style', $_POST['sidebar_style'] ?? 'style1');
...
$navbar_style = getSetting($conn, 'navbar_style', 'style1');
$sidebar_style = getSetting($conn, 'sidebar_style', 'style1');
...
try {
    ...
    if ($result)
        $total_users = $result->fetch_assoc()['c'];
} catch (Exception $e) {
}
...
try {
    ...
    if ($result)
        $total_vpn = $result->fetch_assoc()['c'];
} catch (Exception $e) {
}
...
try {
    ...
    if ($result)
        $total_ssh = $result->fetch_assoc()['c'];
} catch (Exception $e) {
}
...
try {
    ...
    if ($result)
        $db_size = $result->fetch_assoc()['size'] ?? 0;
} catch (Exception $e) {
}
                ...
                <div class="col-md-3">
                    <div class="card-custom">
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link active" data-bs-toggle="pill" href="#tab-general"><i
                                    class="fas fa-home me-2"></i>ทั่วไป</a>
                            <a class="nav-link" data-bs-toggle="pill" href="#tab-ai"><i class="fas fa-robot me-2"></i>AI
                                Settings</a>
                            <a class="nav-link" data-bs-toggle="pill" href="#tab-system"><i
                                    class="fas fa-server me-2"></i>ข้อมูลระบบ</a>
                            <a class="nav-link" data-bs-toggle="pill" href="#tab-maintenance"><i
                                    class="fas fa-tools me-2"></i>การบำรุงรักษา</a>
                            <a class="nav-link" data-bs-toggle="pill" href="#tab-backup"><i
                                    class="fas fa-database me-2"></i>Backup</a>
                            <a class="nav-link" data-bs-toggle="pill" href="#tab-logs"><i
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" name="allow_register">
                                                <option value="1" <?php echo $allow_register == '1' ? 'selected' : ''; ?>>
                                                    เปิดรับสมัคร</option>
                                                <option value="0" <?php echo $allow_register == '0' ? 'selected' : ''; ?>>
                                                    ปิดรับสมัคร</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">รูปแบบแถบนำทาง (Navbar)</label>
                                            <select class="form-select" name="navbar_style">
                                                <option value="style1" <?php echo $navbar_style == 'style1' ? 'selected' : ''; ?>>Style 1 (Full Width - ค่าเริ่มต้น)</option>
                                                <option value="style2" <?php echo $navbar_style == 'style2' ? 'selected' : ''; ?>>Style 2 (Floating Glassmorphism)</option>
                                                <option value="style3" <?php echo $navbar_style == 'style3' ? 'selected' : ''; ?>>Style 3 (Minimalist Underline)</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">รูปแบบเมนูด้านข้าง (Sidebar/Mobile)</label>
                                            <select class="form-select" name="sidebar_style">
                                                <option value="style1" <?php echo $sidebar_style == 'style1' ? 'selected' : ''; ?>>Style 1 (Slide from Left - ค่าเริ่มต้น)</option>
                                                <option value="style2" <?php echo $sidebar_style == 'style2' ? 'selected' : ''; ?>>Style 2 (Floating Panel Right)</option>
                                                <option value="style3" <?php echo $sidebar_style == 'style3' ? 'selected' : ''; ?>>Style 3 (Bottom Sheet Menu)</option>
                                            </select>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">ประกาศหน้าเว็บ</label>
                                            <textarea class="form-control" name="announcement" rows="3"
                                                placeholder="ข้อความประกาศ (จะแสดงบนหน้าเว็บ)"><?php echo htmlspecialchars($announcement); ?></textarea>
                                        </div>
                                        <div class="col-12">
                                                ...
                                                <?php foreach ($site_themes as $key => $theme_data): ?>
                                                    <div class="text-center">
                                                        <input type="radio" name="site_theme" value="<?php echo $key; ?>"
                                                            id="theme_<?php echo $key; ?>" <?php echo $current_theme === $key ? 'checked' : ''; ?> style="display: none;">
                                                        <label for="theme_<?php echo $key; ?>"
                                                            class="theme-swatch <?php echo $current_theme === $key ? 'active' : ''; ?>"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <label class="form-label mb-0">
                                                    <i class="fas fa-palette me-2 text-info"></i>กำหนดสีเอง (Custom
                                                    Colors)
                                                </label>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="useCustomColors"
                                                        name="use_custom_colors" value="1" <?php echo $use_custom_colors == '1' ? 'checked' : ''; ?>>
                                                    <label class="form-check-label"
                                                        for="useCustomColors">เปิดใช้งาน</label>
                                                </div>
                                            </div>

                                            <div id="customColorsPanel" class="p-3 rounded mb-3"
                                                style="background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); <?php echo $use_custom_colors != '1' ? 'opacity: 0.5; pointer-events: none;' : ''; ?>">
                                                <div class="row g-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label small">สีพื้นหลังเว็บ</label>
                                                        <div class="input-group">
                                                            <input type="color" class="form-control form-control-color"
                                                                id="customBgBody" name="custom_bg_body"
                                                                value="<?php echo $custom_bg_body ?: '#000000'; ?>"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="color" class="form-control form-control-color"
                                                                id="customBgCard" name="custom_bg_card"
                                                                value="<?php echo $custom_bg_card ? preg_replace('/rgba?\([^)]+\)/', '#1a1a1a', $custom_bg_card) : '#1a1a1a'; ?>"
                                                                style="width: 50px; height: 40px;">
                                                            <input type="text" class="form-control"
                                                                id="customBgCardText"
                                                                value="<?php echo $custom_bg_card ?: 'rgba(20,20,20,0.95)'; ?>"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="color" class="form-control form-control-color"
                                                                id="customPrimary" name="custom_primary_color"
                                                                value="<?php echo $custom_primary_color ?: '#E50914'; ?>"
                                                                style="width: 50px; height: 40px;">
                                                            <input type="text" class="form-control"
                                                                id="customPrimaryText"
                                                                value="<?php echo $custom_primary_color ?: '#E50914'; ?>"
                                                                placeholder="#E50914">
                                                        </div>
                                                ...
                                                <!-- Preview Box -->
                                                <div class="mt-3 p-3 rounded" id="colorPreview"
                                                    style="background: <?php echo $custom_bg_card ?: 'rgba(20,20,20,0.95)'; ?>; border: 1px solid <?php echo $custom_primary_color ?: '#E50914'; ?>;">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <span>ตัวอย่าง Preview</span>
                                                        <button type="button" class="btn btn-sm" id="previewBtn"
                                                            style="background: <?php echo $custom_primary_color ?: '#E50914'; ?>; color: #fff;">ปุ่มตัวอย่าง</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <small class="text-secondary">
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between align-items-center p-3 rounded"
                                            ...
                                            <div>
                                                ...
                                                <small class="text-secondary">เปิดให้ AI
                                                    ตอบคำถามลูกค้าอัตโนมัติในแชท</small>
                                            </div>
                                            <div class="form-check form-switch">
                                    ...
                                    <div class="col-12">
                                        <div class="alert alert-info mb-0">
                                            ...
                                            <strong>AI Fallback:</strong> ถ้า Typhoon API ไม่ตอบ ระบบจะใช้ Fallback
                                            Response อัตโนมัติ<br>
                                            <small class="text-muted">ดู Log ได้ที่ <code>logs/ai_debug.log</code> และ
                                                <code>logs/chat_debug.log</code></small>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info-box">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="value"><?php echo number_format($total_vpn + $total_ssh); ?>
                                                รายการ</div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-box">
                                            ...
                                            <div class="value">
                                                <?php echo function_exists('curl_init') ? '<span class="text-success">Enabled</span>' : '<span class="text-danger">Disabled</span>'; ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-maintenance">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card bg-dark border-secondary p-3">
                                            ...
                                            <p class="small text-secondary mb-2">ขนาด Log ปัจจุบัน:
                                                <?php echo $total_log_size; ?> KB
                                            </p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card bg-dark border-secondary p-3">
                                            ...
                                            <p class="small text-secondary mb-2">ล้าง cache เพื่อให้ระบบทำงานเร็วขึ้น
                                            </p>
                            ...
                            <div class="card-custom danger-zone">
                                <h5 class="card-title text-danger"><i
                                        class="fas fa-exclamation-triangle me-2"></i>Danger Zone</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card bg-dark border-danger p-3">
                                            <h6 class="text-danger"><i class="fas fa-user-times me-2"></i>ลบ Expired
                                                Rentals</h6>
                                            ...
                                            <div class="input-group input-group-sm mb-2">
                                                <input type="number" class="form-control" id="cleanupDays" value="30"
                                                    min="7" max="365">
                                                <span
                                                    class="input-group-text bg-dark text-white border-secondary">วัน</span>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card bg-dark border-danger p-3">
                                            <h6 class="text-danger"><i class="fas fa-database me-2"></i>Fix Duplicate
                                                Settings</h6>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="card bg-dark border-success p-3">
                                            <h6 class="text-success"><i class="fas fa-download me-2"></i>สร้าง Backup
                                                ใหม่</h6>
                                    ...
                                    <table class="table table-dark table-sm">
                                        ...
                                        <tbody>
                                            <?php foreach ($log_files as $file): ?>
                                                <tr>
                                                    <td><i
                                                            class="fas fa-file-alt me-2 text-secondary"></i><?php echo basename($file); ?>
                                                    </td>
                                                    <td><?php echo round(filesize($file) / 1024, 2); ?> KB</td>
                                                    <td><?php echo date('Y-m-d H:i:s', filemtime($file)); ?></td>
                                                    <td>
                                                        <button class="btn btn-sm btn-outline-info"
                                                            onclick="viewLog('<?php echo basename($file); ?>')">
                                            ...
                                            <?php if (empty($log_files)): ?>
                                                <tr>
                                                    <td colspan="4" class="text-center text-secondary">ไม่พบ Log files</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content bg-dark text-white border-secondary">
                    ...
                    <div class="modal-body">
                        <pre id="logContent" class="bg-black p-3 rounded"
                            style="max-height: 500px; overflow-y: auto; font-size: 0.8rem; white-space: pre-wrap;"></pre>
                    </div>
                </div>
            </div>
        </div>
